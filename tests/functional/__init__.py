...
from tests.functional.swift_test_client import Account, Connection, \
    ResponseError
...
from tests.unit import debug_logger, FakeMemcache
...
from oioswift.server import Application
...
def in_process_setup(the_object_server=object_server):
    ...
    config.update({
        ...
        # For oioswif configuration
        'sds_proxy_url': 'http://172.28.128.3:6006',
    ...
    prosrv = Application(config, logger=debug_logger('proxy'))
